...
var file_flavor_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x3a, 0x0a, 0x0e, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x6c, 0x61, 0x76, 0x6f, 0x72, 0x73,
	0x52, 0x65, 0x73, 0x12, 0x28, 0x0a, 0x07, 0x66, 0x6c, 0x61, 0x76, 0x6f, 0x72, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x66, 0x6c, 0x61, 0x76, 0x6f, 0x72, 0x2e, 0x46, 0x6c,
	0x61, 0x76, 0x6f, 0x72, 0x52, 0x07, 0x66, 0x6c, 0x61, 0x76, 0x6f, 0x72, 0x73, 0x22, 0x89, 0x01,
	0x0a, 0x0c, 0x47, 0x65, 0x74, 0x46, 0x6c, 0x61, 0x76, 0x6f, 0x72, 0x52, 0x65, 0x71, 0x12, 0x16,
	...
	,
...
var file_flavor_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_flavor_proto_depIdxs = []int32{
	...
	1, // 1: flavor.FlavorService.ListFlavors:input_type -> flavor.ListFlavorsReq
	3, // 2: flavor.FlavorService.GetFlavor:input_type -> flavor.GetFlavorReq
	2, // 3: flavor.FlavorService.ListFlavors:output_type -> flavor.ListFlavorsRes
	0, // 4: flavor.FlavorService.GetFlavor:output_type -> flavor.Flavor
...
type FlavorServiceClient interface {
	...
	//获取规格信息
	GetFlavor(ctx context.Context, in *GetFlavorReq, opts ...grpc.CallOption) (*Flavor, error)
}
...
func (c *flavorServiceClient) GetFlavor(ctx context.Context, in *GetFlavorReq, opts ...grpc.CallOption) (*Flavor, error) {
	out := new(Flavor)
...
type FlavorServiceServer interface {
	...
	//获取规格信息
	GetFlavor(context.Context, *GetFlavorReq) (*Flavor, error)
}
...
func (*UnimplementedFlavorServiceServer) GetFlavor(context.Context, *GetFlavorReq) (*Flavor, error) {
