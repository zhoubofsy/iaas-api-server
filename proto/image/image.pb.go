...
var file_image_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x22, 0xab, 0x01, 0x0a, 0x0d, 0x4c, 0x69, 0x73,
	...
	0x72, 0x6d, 0x55, 0x73, 0x65, 0x72, 0x69, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x61, 0x67, 0x65,
	...
	0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x22, 0x35, 0x0a, 0x0d, 0x4c, 0x69, 0x73, 0x74, 0x49, 0x6d,
	...
	0x49, 0x6d, 0x61, 0x67, 0x65, 0x52, 0x06, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x73, 0x22, 0x86, 0x01,
	0x0a, 0x0b, 0x47, 0x65, 0x74, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x12, 0x16, 0x0a,
	...
	,
...
var file_image_proto_depIdxs = []int32{
	...
	1, // 1: image.ImageService.ListImages:input_type -> image.ListImagesReq
	3, // 2: image.ImageService.GetImage:input_type -> image.GetImageReq
	2, // 3: image.ImageService.ListImages:output_type -> image.ListImagesRes
	0, // 4: image.ImageService.GetImage:output_type -> image.Image
...
type ImageServiceClient interface {
	...
	//获取镜像信息
	GetImage(ctx context.Context, in *GetImageReq, opts ...grpc.CallOption) (*Image, error)
}
...
func (c *imageServiceClient) GetImage(ctx context.Context, in *GetImageReq, opts ...grpc.CallOption) (*Image, error) {
	out := new(Image)
...
type ImageServiceServer interface {
	...
	//获取镜像信息
	GetImage(context.Context, *GetImageReq) (*Image, error)
}
...
func (*UnimplementedImageServiceServer) GetImage(context.Context, *GetImageReq) (*Image, error) {
