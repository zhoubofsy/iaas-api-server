...
type BindFloatIpToInstanceReq struct {
	...
	VpcRouterId    string `protobuf:"bytes,5,opt,name=vpc_router_id,json=vpcRouterId,proto3" json:"vpc_router_id,omitempty"`
}
...
func (x *BindFloatIpToInstanceReq) GetVpcRouterId() string {
	if x != nil {
...
var file_floatip_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x76, 0x70, 0x63,
